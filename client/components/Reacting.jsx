...
function Reacting(props) {
  const { avatar, addReaction, height, id, myRatings, reaction, userRatings, width } = props;
  ...
  return (
    ...
    >
      ...
      <SVGButton
        label="Compare"
        to="/compare"
        transform={`translate(${width - (sv.vars.buttonWidth + sv.vars.spacingMD)}, ${sv.vars.spacingMD})`}
      />
      <text
        style={sv.h1}
        x={headingLeft}
      ...
      <g transform={`translate(${headingLeft}, ${h1Baseline + (sv.vars.spacingSM * 2)})`}>
        <image xlinkHref={avatar} x="0" y="0" height={sv.vars.spacingXL} width={sv.vars.spacingXL} clipPath="url(#circleClipPath)" />
        <g transform={`translate(${sv.vars.spacingXL + sv.vars.spacingMD}, 0)`}>
          <text
            style={sv.h2}
            x={0}
        ...
        <g transform={`translate(${sv.vars.spacingXL + sv.vars.spacingMD + 100}, 0)`}>
          <text
            style={sv.h2}
            x={0}
            y={sv.vars.h2Baseline}
      ...
      <g transform={`translate(${shareGroupRight}, ${h1Baseline + (sv.vars.spacingMD)})`}>
        <g>
          <rect
            height={44}
        ...
        <g id="users" transform={`translate(16, ${44 + 8})`}>
          <text style={sv.label} x={`${sv.vars.spacingMD * 2.5}`} y="21">{userRatings.length}k</text>
          <g fill={sv.vars.colorWhite}>
            ...
            <path d="M8.01188219,15.9634856 C9.34523298,15.9634856 10.5954459,16.453917 11.5503365,17.306915 L13.3333333,17.3016127 C12.1281297,15.7030517 10.1932942,14.6666667 8.01188219,14.6666667 C5.8160748,14.6666667 3.87010896,15.7167753 2.66666667,17.3333333 L4.44990334,17.3280303 C5.40749596,16.4622502 6.66734981,15.9634856 8.01188219,15.9634856 Z" id="Oval-21-Copy-2" />
        ...
        <g id="friends" transform={`translate(${sv.vars.buttonWidth / 2 + 16}, ${44 + 8})`}>
